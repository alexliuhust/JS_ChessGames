...
Enemy.prototype = {
  ...
  draw: function () {
    ...
    if (this.frozenTime > 0) {
      Canvas.drawImg(
        this.cxt,
        this.img,
        this.enemyMap[this.type].x,
        this.enemyMap[this.type].y + 40,
        this.width,
        this.height,
        this.x,
        this.y,
  ...
  update: function () {
    ...
    if (
      !this.nextPosition ||
      (this.x >= this.nextPosition.x - 5 &&
        this.x <= this.nextPosition.x &&
        this.y >= this.nextPosition.y - 5 &&
      ...
      if (xIndex + 1 >= 10) {
        ...
        if (
          ...
          !this.hadWalk[xIndex + "_" + (yIndex + 1)]
        ) {
          this.dir = "down";
          yIndex += 1;
        }
        //判断往右能否走
          ...
          MapData[xIndex + 1][yIndex] &&
          !this.hadWalk[xIndex + 1 + "_" + yIndex]
        ) {
          this.dir = "right";
          xIndex += 1;
        } else if (
