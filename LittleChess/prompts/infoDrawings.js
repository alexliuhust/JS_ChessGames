...
function drawTitle(cxt, piece) {
  ...
  Canvas.drawText(cxt, piece.name, 105, 45, "white", 30);
  Canvas.drawText(cxt, piece.description, 105, 80, "white", 20);
}
...
function drawCombatData(cxt, piece) {
  ...
  let attackText = `Damage:  Melee[ ${piece.c_meleeAttack} ]  Missle[ ${piece.c_missleAttack} ]  Charge[ ${piece.c_chargeAttack} ]`;
  let missleRange = `Range:     ${piece.c_missleRange}`;
  let missleRadius = `Radius:    ${piece.c_missleRadius}`;

  Canvas.drawText(cxt, speedText, textLeftMostX, textY, "white", 18);
  textY += 30;
  Canvas.drawText(cxt, armorText, textLeftMostX, textY, "white", 18);
  textY += 30;
  Canvas.drawText(cxt, attackText, textLeftMostX, textY, "white", 18);
  textY += 30;
  Canvas.drawText(cxt, missleRange, textLeftMostX, textY, "white", 18);
  textY += 30;
  Canvas.drawText(cxt, missleRadius, textLeftMostX, textY, "white", 18);
}
