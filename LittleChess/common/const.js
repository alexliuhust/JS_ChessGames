...
export const Category = {
  ...
  AC: "Missile-Inf",
  MAC: "Melee-Missile-Inf",
  S_AC: "Shield-Missile-Inf",
  A_AC: "Armored-Missile-Inf",
  S_MAC: "Shield-Melee-Missile-Inf",
  A_MAC: "Armored-Melee-Missile-Inf",

  MLC: "Melee-Cavalry",
  MSC: "Missile-Cavalry",
  CGC: "Charging-Cavalry",
  MSCGC: "Missile-Charging-Cavalry",
...
export const TraitDescription = {
  ...
  AAM: "Attacks ignore a portion of the\ntarget's armor.",
  ...
  AM: "Higher overall armor, but slightly\nlower evasion.",
  ...
  LR: "Above-average missile-attack\nrange.",
